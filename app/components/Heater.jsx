...
export default function () {
  return (
    <div className=" text-sm sm:text-lg heater-section mx-auto text-black " style={{ fontFamily: 'inter-regular, sans-serif',  lineHeight: '1.4' }}>
      ...
      <div className="heater-section__info flex">
        ...
        <div className="heater-section__about p-6">
          <h2 className="heater-section__title font-bold text-3xl text-center lg:text-5xl mb-8">Об утеплителе</h2>
